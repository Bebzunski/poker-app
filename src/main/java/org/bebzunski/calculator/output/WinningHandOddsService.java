...
public class WinningHandOddsService {
	...
	public WinningOddsOutput build(List<PlayerCards> playersCards, List<TableCardsIteration> iterations) {
	...
	private List<PlayerCards> findIterationWinners(List<PlayerCards> players, TableCardsIteration iteration) {
