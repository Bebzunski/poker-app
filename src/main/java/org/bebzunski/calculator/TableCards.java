...
public class TableCards {
	...
	public TableCards(@NonNull Deck deck) {
		this.deck = deck;
	...
	public List<TableCardsOutput> dealTimes(int times) {
	...
	private TableCardsOutput deal() {
		deck.loadFresh();
		dealVariableCards();
		return new TableCardsOutput(getFlop(), getCard(TURN), getCard(RIVER));
	}
