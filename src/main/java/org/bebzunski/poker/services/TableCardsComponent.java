...
import static org.bebzunski.poker.enums.Street.PRE_FLOP;
...
public class TableCardsComponent {
	...
	public List<BoardRunout> dealTimes(int times) {
	...
	private BoardRunout deal() {
		deck.loadFresh();
		dealVariableCards();
		return new BoardRunout(getFlop(), getCard(TURN), getCard(RIVER));
	}
